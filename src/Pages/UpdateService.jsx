...
const UpdateService = () => {
    ...
    const handleUpdate = (e) => {
        ...
        const price = formData.category === 'pets' ? 0 : parseInt(form.price.value);
            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
                    ...
                    <p className="text-gray-600 mb-6">
                        Update the details of your pet or pet-related product
                    </p>
                ...
                <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <h3 className="font-semibold text-blue-800 mb-2">Update Instructions:</h3>
